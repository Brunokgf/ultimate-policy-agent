...
const getLocalImages = (productId: string): string[] => {
  const imageMap: Record<string, string[]> = {
    ...
    'tel-18': ['/src/assets/products/xiaomi-redmi-13c-green.jpg', '/src/assets/products/xiaomi-redmi-13c-green-front.jpg', '/src/assets/products/xiaomi-redmi-13c-green-back.jpg', '/src/assets/products/xiaomi-redmi-13c-green-side.jpg', '/src/assets/products/xiaomi-redmi-13c-green-angle.jpg', '/src/assets/products/xiaomi-redmi-13c-green-colors.jpg'],
    'tel-19': ['/src/assets/products/samsung-a14-black.jpg', '/src/assets/products/samsung-a14-black-front.jpg', '/src/assets/products/samsung-a14-black-back.jpg', '/src/assets/products/samsung-a14-black-side.jpg', '/src/assets/products/samsung-a14-black-angle.jpg', '/src/assets/products/samsung-a14-black-colors.jpg', '/src/assets/products/samsung-a14-black-layout.jpg'],
    'tel-20': ['/src/assets/products/motorola-moto-g24-graphite.jpg', '/src/assets/products/motorola-moto-g24-graphite-front.jpg', '/src/assets/products/motorola-moto-g24-graphite-back.jpg', '/src/assets/products/motorola-moto-g24-graphite-side.jpg', '/src/assets/products/motorola-moto-g24-graphite-angle.jpg', '/src/assets/products/motorola-moto-g24-graphite-back2.jpg', '/src/assets/products/motorola-moto-g24-graphite-layout.jpg'],
    ...
    'tel-37': ['/src/assets/products/realme-c55-black.jpg', '/src/assets/products/realme-c55-black-front.jpg', '/src/assets/products/realme-c55-black-angle.jpg'],
    'tel-38': ['/src/assets/products/samsung-a04s-green.jpg', '/src/assets/products/samsung-a04s-green-front.jpg', '/src/assets/products/samsung-a04s-green-back.jpg'],
    'tel-39': ['/src/assets/products/xiaomi-redmi-a2-blue.jpg', '/src/assets/products/xiaomi-redmi-a2-blue-front.jpg', '/src/assets/products/xiaomi-redmi-a2-blue-back.jpg', '/src/assets/products/xiaomi-redmi-a2-blue-angle.jpg'],
