    ...
    <div className="min-h-screen bg-[#f8f9fa]">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 sm:mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold">Telefones</h2>
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 w-full md:w-auto">
            <div className="flex-1 md:flex-initial md:w-80">
              <SearchBar onSearch={setSearchQuery} placeholder="Pesquisar telefones..." />
            </div>
            <Button onClick={() => navigate('/carrinho')} className="bg-[#1e90ff] hover:bg-[#0a65c0] relative whitespace-nowrap">
