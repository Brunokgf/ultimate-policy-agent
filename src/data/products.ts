...
import samsungS24UltraFront from '@/assets/products/samsung-s24-ultra-front.jpg';
import samsungS24UltraBack from '@/assets/products/samsung-s24-ultra-back.jpg';
import samsungS24UltraSide from '@/assets/products/samsung-s24-ultra-side.jpg';
import samsungS23Fe from '@/assets/products/samsung-s23-fe-graphite.jpg';
import samsungS23FeFront from '@/assets/products/samsung-s23-fe-graphite-front.jpg';
import samsungS23FeBack from '@/assets/products/samsung-s23-fe-graphite-back.jpg';
import samsungS23FeSide from '@/assets/products/samsung-s23-fe-graphite-side.jpg';
import samsungA54 from '@/assets/products/samsung-a54-green.jpg';
import samsungA54Front from '@/assets/products/samsung-a54-green-front.jpg';
import samsungA54Back from '@/assets/products/samsung-a54-green-back.jpg';
import samsungA54Side from '@/assets/products/samsung-a54-green-side.jpg';
import samsungA34 from '@/assets/products/samsung-a34-violet.jpg';
import samsungA34Front from '@/assets/products/samsung-a34-violet-front.jpg';
import samsungA34Back from '@/assets/products/samsung-a34-violet-back.jpg';
import samsungA34Side from '@/assets/products/samsung-a34-violet-side.jpg';
import samsungA14 from '@/assets/products/samsung-a14-black.jpg';
import samsungA14Front from '@/assets/products/samsung-a14-black-front.jpg';
import samsungA14Back from '@/assets/products/samsung-a14-black-back.jpg';
import samsungA14Side from '@/assets/products/samsung-a14-black-side.jpg';
import samsungM54 from '@/assets/products/samsung-m54-silver.jpg';
import samsungM54Front from '@/assets/products/samsung-m54-silver-front.jpg';
import samsungM54Back from '@/assets/products/samsung-m54-silver-back.jpg';
import samsungM54Side from '@/assets/products/samsung-m54-silver-side.jpg';
import samsungZFlip5 from '@/assets/products/samsung-z-flip5-lavender.jpg';
import samsungZFlip5Front from '@/assets/products/samsung-z-flip5-lavender-front.jpg';
import samsungZFlip5Back from '@/assets/products/samsung-z-flip5-lavender-back.jpg';
import samsungZFlip5Side from '@/assets/products/samsung-z-flip5-lavender-side.jpg';
import samsungA24 from '@/assets/products/samsung-a24-black.jpg';
import samsungA04s from '@/assets/products/samsung-a04s-green.jpg';
import samsungS21Fe from '@/assets/products/samsung-s21-fe-white.jpg';

// Phones - Xiaomi/Poco/Redmi
import xiaomiPocoX6Pro from '@/assets/products/xiaomi-poco-x6-pro.jpg';
import xiaomiPocoX6ProFront from '@/assets/products/xiaomi-poco-x6-pro-front.jpg';
import xiaomiPocoX6ProBack from '@/assets/products/xiaomi-poco-x6-pro-back.jpg';
import xiaomiPocoX6ProSide from '@/assets/products/xiaomi-poco-x6-pro-side.jpg';
import xiaomiRedmi13C from '@/assets/products/xiaomi-redmi-13c-green.jpg';
import xiaomiRedmi13CFront from '@/assets/products/xiaomi-redmi-13c-green-front.jpg';
import xiaomiRedmi13CBack from '@/assets/products/xiaomi-redmi-13c-green-back.jpg';
import xiaomiRedmi13CSide from '@/assets/products/xiaomi-redmi-13c-green-side.jpg';
import xiaomiRedmiNote13Pro from '@/assets/products/xiaomi-redmi-note-13-pro.jpg';
import xiaomiRedmiNote13ProFront from '@/assets/products/xiaomi-redmi-note-13-pro-front.jpg';
import xiaomiRedmiNote13ProBack from '@/assets/products/xiaomi-redmi-note-13-pro-back.jpg';
import xiaomiRedmiNote13ProSide from '@/assets/products/xiaomi-redmi-note-13-pro-side.jpg';
import xiaomiRedmiNote12 from '@/assets/products/xiaomi-redmi-note-12-blue.jpg';
import xiaomiRedmiNote12Front from '@/assets/products/xiaomi-redmi-note-12-blue-front.jpg';
import xiaomiRedmiNote12Back from '@/assets/products/xiaomi-redmi-note-12-blue-back.jpg';
import xiaomiRedmiNote12Side from '@/assets/products/xiaomi-redmi-note-12-blue-side.jpg';
import xiaomi13T from '@/assets/products/xiaomi-13t-black.jpg';
import xiaomi12Lite from '@/assets/products/xiaomi-12-lite-pink.jpg';
import xiaomiPocoM6Pro from '@/assets/products/xiaomi-poco-m6-pro-blue.jpg';
import xiaomiPocoF5Pro from '@/assets/products/poco-f5-pro-white.jpg';
import xiaomiRedmiA2 from '@/assets/products/xiaomi-redmi-a2-blue.jpg';

// Phones - Motorola
import motorolaMotoG54 from '@/assets/products/motorola-moto-g54.jpg';
import motorolaMotoG54Front from '@/assets/products/motorola-moto-g54-front.jpg';
import motorolaMotoG54Back from '@/assets/products/motorola-moto-g54-back.jpg';
import motorolaMotoG54Side from '@/assets/products/motorola-moto-g54-side.jpg';
import motorolaMotoG24 from '@/assets/products/motorola-moto-g24-graphite.jpg';
import motorolaMotoG24Front from '@/assets/products/motorola-moto-g24-graphite-front.jpg';
import motorolaMotoG24Back from '@/assets/products/motorola-moto-g24-graphite-back.jpg';
import motorolaMotoG24Side from '@/assets/products/motorola-moto-g24-graphite-side.jpg';
import motorolaEdge40Neo from '@/assets/products/motorola-edge-40-neo.jpg';
import motorolaEdge40NeoFront from '@/assets/products/motorola-edge-40-neo-front.jpg';
import motorolaEdge40NeoBack from '@/assets/products/motorola-edge-40-neo-back.jpg';
import motorolaEdge40NeoSide from '@/assets/products/motorola-edge-40-neo-side.jpg';
import motorolaG84 from '@/assets/products/motorola-g84-black.jpg';
import motorolaG84Front from '@/assets/products/motorola-g84-black-front.jpg';
import motorolaG84Back from '@/assets/products/motorola-g84-black-back.jpg';
import motorolaG84Side from '@/assets/products/motorola-g84-black-side.jpg';
import motorolaRazr40 from '@/assets/products/motorola-razr-40-black.jpg';
import motorolaRazr40Front from '@/assets/products/motorola-razr-40-black-front.jpg';
import motorolaRazr40Back from '@/assets/products/motorola-razr-40-black-back.jpg';
import motorolaRazr40Side from '@/assets/products/motorola-razr-40-black-side.jpg';
import motorolaEdge30 from '@/assets/products/motorola-edge-30-fusion-blue.jpg';
import motorolaMotoG73 from '@/assets/products/motorola-moto-g73-white.jpg';
import motorolaMotoE13 from '@/assets/products/motorola-moto-e13-graphite.jpg';

// Phones - iPhone
import iphone15ProMax from '@/assets/products/iphone-15-pro-max.jpg';
import iphone15ProMaxFront from '@/assets/products/iphone-15-pro-max-front.jpg';
import iphone15ProMaxBack from '@/assets/products/iphone-15-pro-max-back.jpg';
import iphone15ProMaxSide from '@/assets/products/iphone-15-pro-max-side.jpg';
import iphone14 from '@/assets/products/iphone-14-purple.jpg';
import iphone14Front from '@/assets/products/iphone-14-purple-front.jpg';
import iphone14Back from '@/assets/products/iphone-14-purple-back.jpg';
import iphone14Side from '@/assets/products/iphone-14-purple-side.jpg';
import iphone13 from '@/assets/products/iphone-13-blue.jpg';
import iphone13Front from '@/assets/products/iphone-13-blue-front.jpg';
import iphone13Back from '@/assets/products/iphone-13-blue-back.jpg';
import iphone13Side from '@/assets/products/iphone-13-blue-side.jpg';
import iphoneSe2022 from '@/assets/products/iphone-se-2022-white.jpg';
import iphoneSe2022Front from '@/assets/products/iphone-se-2022-white-front.jpg';
import iphoneSe2022Back from '@/assets/products/iphone-se-2022-white-back.jpg';
import iphoneSe2022Side from '@/assets/products/iphone-se-2022-white-side.jpg';
import iphone12 from '@/assets/products/iphone-12-black.jpg';

// Phones - Others
import oneplusNordCe3 from '@/assets/products/oneplus-nord-ce3.jpg';
import oneplusNordCe3Front from '@/assets/products/oneplus-nord-ce3-front.jpg';
import oneplusNordCe3Back from '@/assets/products/oneplus-nord-ce3-back.jpg';
import oneplusNordCe3Side from '@/assets/products/oneplus-nord-ce3-side.jpg';
import oneplus11 from '@/assets/products/oneplus-11-green.jpg';
import realme11ProPlus from '@/assets/products/realme-11-pro-plus.jpg';
import realme11ProPlusFront from '@/assets/products/realme-11-pro-plus-front.jpg';
import realme11ProPlusBack from '@/assets/products/realme-11-pro-plus-back.jpg';
import realme11ProPlusSide from '@/assets/products/realme-11-pro-plus-side.jpg';
import realmeC55 from '@/assets/products/realme-c55-black.jpg';
import realmeGtNeo5 from '@/assets/products/realme-gt-neo5-white.jpg';
import nothingPhone2 from '@/assets/products/nothing-phone-2-white.jpg';
import nothingPhone2Front from '@/assets/products/nothing-phone-2-white-front.jpg';
import nothingPhone2Back from '@/assets/products/nothing-phone-2-white-back.jpg';
import nothingPhone2Side from '@/assets/products/nothing-phone-2-white-side.jpg';
import asusZenfone10 from '@/assets/products/asus-zenfone-10-black.jpg';
import googlePixel7a from '@/assets/products/google-pixel-7a-blue.jpg';

// Laptops
import macbookPro14M3 from '@/assets/products/macbook-pro-14-m3.jpg';
import macbookPro14M3Front from '@/assets/products/macbook-pro-14-m3-front.jpg';
import macbookPro14M3Side from '@/assets/products/macbook-pro-14-m3-side.jpg';
import macbookPro14M3Closed from '@/assets/products/macbook-pro-14-m3-closed.jpg';
import dellInspiron15 from '@/assets/products/dell-inspiron-15-silver.jpg';
import dellInspiron15Front from '@/assets/products/dell-inspiron-15-silver-front.jpg';
import dellInspiron15Side from '@/assets/products/dell-inspiron-15-silver-side.jpg';
import dellInspiron15Closed from '@/assets/products/dell-inspiron-15-silver-closed.jpg';
import lenovoIdeapad3i from '@/assets/products/lenovo-ideapad-3i-gray.jpg';
import lenovoIdeapad3iFront from '@/assets/products/lenovo-ideapad-3i-gray-front.jpg';
import lenovoIdeapad3iSide from '@/assets/products/lenovo-ideapad-3i-gray-side.jpg';
import lenovoIdeapad3iClosed from '@/assets/products/lenovo-ideapad-3i-gray-closed.jpg';

// Headphones
import sonyWh1000xm5 from '@/assets/products/sony-wh1000xm5.jpg';
import sonyWh1000xm5Front from '@/assets/products/sony-wh1000xm5-front.jpg';
import sonyWh1000xm5Side from '@/assets/products/sony-wh1000xm5-side.jpg';
import sonyWh1000xm5Folded from '@/assets/products/sony-wh1000xm5-folded.jpg';
import sonyWf1000xm5 from '@/assets/products/sony-wf-1000xm5.jpg';
import sonyWf1000xm5Front from '@/assets/products/sony-wf-1000xm5-front.jpg';
import sonyWf1000xm5Open from '@/assets/products/sony-wf-1000xm5-open.jpg';
import sonyWf1000xm5Side from '@/assets/products/sony-wf-1000xm5-side.jpg';
import airpodsPro2 from '@/assets/products/airpods-pro-2.jpg';
import airpodsPro2Front from '@/assets/products/airpods-pro-2-front.jpg';
import airpodsPro2Open from '@/assets/products/airpods-pro-2-open.jpg';
import airpodsPro2Side from '@/assets/products/airpods-pro-2-side.jpg';
import galaxyBuds2Pro from '@/assets/products/galaxy-buds2-pro.jpg';
import galaxyBuds2ProFront from '@/assets/products/galaxy-buds2-pro-front.jpg';
import galaxyBuds2ProOpen from '@/assets/products/galaxy-buds2-pro-open.jpg';
import galaxyBuds2ProSide from '@/assets/products/galaxy-buds2-pro-side.jpg';
import sennheiserMomentum4 from '@/assets/products/sennheiser-momentum-4.jpg';
import sennheiserMomentum4Front from '@/assets/products/sennheiser-momentum-4-front.jpg';
import sennheiserMomentum4Side from '@/assets/products/sennheiser-momentum-4-side.jpg';
import sennheiserMomentum4Folded from '@/assets/products/sennheiser-momentum-4-folded.jpg';
import beatsStudioBudsPlus from '@/assets/products/beats-studio-buds-plus.jpg';
import beatsStudioBudsPlusFront from '@/assets/products/beats-studio-buds-plus-front.jpg';
import beatsStudioBudsPlusOpen from '@/assets/products/beats-studio-buds-plus-open.jpg';
import beatsStudioBudsPlusSide from '@/assets/products/beats-studio-buds-plus-side.jpg';
import boseQuietcomfortEarbuds2 from '@/assets/products/bose-quietcomfort-earbuds-ii.jpg';
import boseQuietcomfortEarbuds2Front from '@/assets/products/bose-quietcomfort-earbuds-ii-front.jpg';
import boseQuietcomfortEarbuds2Open from '@/assets/products/bose-quietcomfort-earbuds-ii-open.jpg';
import boseQuietcomfortEarbuds2Side from '@/assets/products/bose-quietcomfort-earbuds-ii-side.jpg';
import jblTune510bt from '@/assets/products/jbl-tune-510bt.jpg';
import jblTune510btFront from '@/assets/products/jbl-tune-510bt-front.jpg';
import jblTune510btSide from '@/assets/products/jbl-tune-510bt-side.jpg';
import jblTune510btFolded from '@/assets/products/jbl-tune-510bt-folded.jpg';
import jblLivePro2 from '@/assets/products/jbl-live-pro-2.jpg';
import xiaomiRedmiBuds4Pro from '@/assets/products/xiaomi-redmi-buds-4-pro.jpg';
import motorolaMotoBudsPlus from '@/assets/products/motorola-moto-buds-plus.jpg';
import ankerSoundcoreLifeQ30 from '@/assets/products/anker-soundcore-life-q30.jpg';
import edifierW800btPlus from '@/assets/products/edifier-w800bt-plus.jpg';
import philipsTah4205 from '@/assets/products/philips-tah4205.jpg';

// Consoles & Gaming
import ps5Slim from '@/assets/products/playstation-5-slim.jpg';
import ps5SlimFront from '@/assets/products/playstation-5-slim-front.jpg';
import ps5SlimSide from '@/assets/products/playstation-5-slim-side.jpg';
import ps5SlimTop from '@/assets/products/playstation-5-slim-top.jpg';
import xboxSeriesX from '@/assets/products/xbox-series-x-black.jpg';
import xboxSeriesXFront from '@/assets/products/xbox-series-x-black-front.jpg';
import xboxSeriesXSide from '@/assets/products/xbox-series-x-black-side.jpg';
import xboxSeriesXTop from '@/assets/products/xbox-series-x-black-top.jpg';
import switchOled from '@/assets/products/nintendo-switch-oled-white.jpg';
import switchOledFront from '@/assets/products/nintendo-switch-oled-white-front.jpg';
import switchOledDock from '@/assets/products/nintendo-switch-oled-white-dock.jpg';
import switchOledBack from '@/assets/products/nintendo-switch-oled-white-back.jpg';
import controllerWhite from '@/assets/products/controller-white.jpg';
import controllerWhiteFront from '@/assets/products/controller-white-front.jpg';
import controllerWhiteSide from '@/assets/products/controller-white-side.jpg';
import controllerWhiteTop from '@/assets/products/controller-white-top.jpg';

// Accessories
import powerbankBlack from '@/assets/products/powerbank-black.jpg';
import powerbankBlackFront from '@/assets/products/powerbank-black-front.jpg';
import powerbankBlackSide from '@/assets/products/powerbank-black-side.jpg';
import powerbankBlackTop from '@/assets/products/powerbank-black-top.jpg';
...
import keyboardMechanicalFront from '@/assets/products/keyboard-mechanical-front.jpg';
import keyboardMechanicalAngle from '@/assets/products/keyboard-mechanical-angle.jpg';
import keyboardMechanicalSide from '@/assets/products/keyboard-mechanical-side.jpg';
import keyboardRgb from '@/assets/products/keyboard-rgb.jpg';
import keyboardRgbFront from '@/assets/products/keyboard-rgb-front.jpg';
import keyboardRgbAngle from '@/assets/products/keyboard-rgb-angle.jpg';
import keyboardRgbSide from '@/assets/products/keyboard-rgb-side.jpg';
import mouseGaming from '@/assets/products/mouse-gaming.jpg';
import mouseGamingFront from '@/assets/products/mouse-gaming-front.jpg';
import mouseGamingSide from '@/assets/products/mouse-gaming-side.jpg';
import mouseGamingTop from '@/assets/products/mouse-gaming-top.jpg';
import mouseWireless from '@/assets/products/mouse-wireless.jpg';
import mouseWirelessAngle from '@/assets/products/mouse-wireless-angle.jpg';
import mouseWirelessSide from '@/assets/products/mouse-wireless-side.jpg';
import mouseWirelessTop from '@/assets/products/mouse-wireless-top.jpg';

// Monitors & Office
import monitorProfessional from '@/assets/products/monitor-professional.jpg';
import monitorProfessionalFront from '@/assets/products/monitor-professional-front.jpg';
import monitorProfessionalAngle from '@/assets/products/monitor-professional-angle.jpg';
import monitorProfessionalSide from '@/assets/products/monitor-professional-side.jpg';
import monitorCurved from '@/assets/products/monitor-curved.jpg';
import monitorCurvedFront from '@/assets/products/monitor-curved-front.jpg';
import monitorCurvedAngle from '@/assets/products/monitor-curved-angle.jpg';
import monitorCurvedSide from '@/assets/products/monitor-curved-side.jpg';
import officeChair from '@/assets/products/office-chair.jpg';
import officeChairFront from '@/assets/products/office-chair-front.jpg';
import officeChairAngle from '@/assets/products/office-chair-angle.jpg';
import officeChairSide from '@/assets/products/office-chair-side.jpg';
import gamingChair from '@/assets/products/gaming-chair.jpg';
import gamingChairFront from '@/assets/products/gaming-chair-front.jpg';
import gamingChairAngle from '@/assets/products/gaming-chair-angle.jpg';
import gamingChairSide from '@/assets/products/gaming-chair-side.jpg';

// Printers
import printerInkjet from '@/assets/products/printer-inkjet.jpg';
import printerInkjetFront from '@/assets/products/printer-inkjet-front.jpg';
import printerInkjetSide from '@/assets/products/printer-inkjet-side.jpg';
import printerInkjetTop from '@/assets/products/printer-inkjet-top.jpg';
import printerLaser from '@/assets/products/printer-laser.jpg';
import printerLaserFront from '@/assets/products/printer-laser-front.jpg';
import printerLaserAngle from '@/assets/products/printer-laser-angle.jpg';
import printerLaserSide from '@/assets/products/printer-laser-side.jpg';
...
const getProductImages = (categoria: string, productName: string, productId: string = ''): string[] => {
  ...
  const variation = hash % 4; // Increased to 4 variations
  
  // Telefones - Now with 6 different phone images
  if (categoria === 'telefones') {
    const phoneImages = [phoneIphone, phoneSamsung, phonePremiumTitanium, phoneAndroidBlue, phoneMidrangeGreen, phoneFoldable];
    
    if (productName.toLowerCase().includes('iphone') || productName.toLowerCase().includes('apple')) {
      return [phoneIphone, phonePremiumTitanium, phoneIphone];
    }
    if (productName.toLowerCase().includes('fold') || productName.toLowerCase().includes('flip') || productName.toLowerCase().includes('razr')) {
      return [phoneFoldable, phonePremiumTitanium, phoneFoldable];
    }
    if (productName.toLowerCase().includes('samsung') && productName.toLowerCase().includes('ultra')) {
      return [phonePremiumTitanium, phoneSamsung, phonePremiumTitanium];
    }
    if (productName.toLowerCase().includes('galaxy')) {
      return [phoneSamsung, phoneAndroidBlue, phoneSamsung];
    }
    if (productName.toLowerCase().includes('redmi') || productName.toLowerCase().includes('poco') || productName.toLowerCase().includes('xiaomi')) {
      return [phoneAndroidBlue, phoneMidrangeGreen, phoneAndroidBlue];
    }
    
    // Rotation for other phones
    if (variation === 0) return [phoneSamsung, phoneIphone, phoneMidrangeGreen];
    if (variation === 1) return [phoneAndroidBlue, phonePremiumTitanium, phoneSamsung];
    if (variation === 2) return [phoneMidrangeGreen, phoneSamsung, phoneIphone];
    return [phoneIphone, phoneAndroidBlue, phonePremiumTitanium];
  }
  
  // Fones de ouvido - Now with 7 different headphone/earbud images
  if (categoria === 'fones') {
    if (productName.toLowerCase().includes('airpods') || (productName.toLowerCase().includes('apple') && productName.toLowerCase().includes('buds'))) {
      return [headphonesAirpods, earbudsWhite, headphonesAirpods];
    }
    if (productName.toLowerCase().includes('buds') || productName.toLowerCase().includes('tws') || productName.toLowerCase().includes('earbuds')) {
      return [earbudsWhite, headphonesAirpods, earbudsWhite];
    }
    if (productName.toLowerCase().includes('gamer') || productName.toLowerCase().includes('gaming') || 
      ...
      return [headsetRgbGamer, headphonesGaming, headsetRgbGamer];
    }
    if (productName.toLowerCase().includes('sony') || productName.toLowerCase().includes('wh-') || productName.toLowerCase().includes('premium')) {
      return [headphonesSony, headphonesPremiumBlack, headphonesSony];
    }
    if (productName.toLowerCase().includes('jbl') || productName.toLowerCase().includes('edifier') || productName.toLowerCase().includes('philips')) {
      return [headphonesBudget, headphonesSony, headphonesBudget];
    }
    
    // Rotation for other headphones
    if (variation === 0) return [headphonesSony, earbudsWhite, headphonesGaming];
    if (variation === 1) return [earbudsWhite, headphonesAirpods, headphonesPremiumBlack];
    if (variation === 2) return [headphonesBudget, headsetRgbGamer, headphonesSony];
    return [headphonesPremiumBlack, headphonesBudget, earbudsWhite];
  }
  
  // Computadores - Now with 5 different laptop images
  if (categoria === 'computadores') {
    if (productName.toLowerCase().includes('macbook') || productName.toLowerCase().includes('apple')) {
      return [laptopMacbook, laptopUltrabook, laptopMacbook];
    }
    ...
    if (productName.toLowerCase().includes('ultra') || productName.toLowerCase().includes('swift') || productName.toLowerCase().includes('envy')) {
      return [laptopUltrabook, laptopMacbook, laptopUltrabook];
    }
    if (productName.toLowerCase().includes('ideapad') || productName.toLowerCase().includes('essentials') || productName.toLowerCase().includes('aspire')) {
      return [laptopBudget, laptopBusiness, laptopBudget];
    }
    
    // Rotation for other laptops
    if (variation === 0) return [laptopBusiness, laptopGaming, laptopUltrabook];
    if (variation === 1) return [laptopGaming, laptopMacbook, laptopBusiness];
    if (variation === 2) return [laptopUltrabook, laptopBudget, laptopGaming];
    return [laptopMacbook, laptopBusiness, laptopUltrabook];
  }
  ...
  if (categoria === 'impressoras') {
    ...
    if (variation % 2 === 0) return [printerInkjet, printerLaser, printerInkjet];
    return [printerLaser, printerInkjet, printerLaser];
  }
  
  // Games - Now with 4 console images + peripherals
  if (categoria === 'games') {
    if (productName.toLowerCase().includes('playstation') || productName.toLowerCase().includes('ps5') || 
      ...
      return [consolePS5, controllerWhite, consolePS5];
    }
    if (productName.toLowerCase().includes('xbox') || productName.toLowerCase().includes('series')) {
      return [consoleXbox, controllerWhite, consoleXbox];
    }
    if (productName.toLowerCase().includes('switch') || productName.toLowerCase().includes('nintendo') ||
      ...
      return [consoleSwitch, controllerWhite, consoleSwitch];
    }
    if (productName.toLowerCase().includes('controle') || productName.toLowerCase().includes('controller')) {
      return [controllerWhite, consolePS5, controllerWhite];
    }
    ...
    if (productName.toLowerCase().includes('teclado') || productName.toLowerCase().includes('keyboard')) {
      return [keyboardRgb, keyboardMechanical, keyboardRgb];
    }
    if (productName.toLowerCase().includes('mouse')) {
      return [mouseWireless, mouseGaming, mouseWireless];
    }
    if (productName.toLowerCase().includes('monitor')) {
      return [monitorCurved, monitorProfessional, monitorCurved];
    }
    
    // Rotation for other gaming products
    if (variation === 0) return [consolePS5, consoleXbox, controllerWhite];
    if (variation === 1) return [consoleXbox, consoleSwitch, consolePS5];
    if (variation === 2) return [consoleSwitch, consolePS5, consoleXbox];
    return [controllerWhite, consolePS5, consoleXbox];
  }
  
  // Escritório - Now with more monitor, keyboard, and mouse variations
  if (categoria === 'escritorio') {
    ...
    if (productName.toLowerCase().includes('monitor')) {
      if (productName.toLowerCase().includes('curv') || productName.toLowerCase().includes('gam')) {
        return [monitorCurved, monitorProfessional, monitorCurved];
      }
      return [monitorProfessional, monitorCurved, monitorProfessional];
    }
    if (productName.toLowerCase().includes('teclado') || productName.toLowerCase().includes('keyboard')) {
      if (productName.toLowerCase().includes('mecânico') || productName.toLowerCase().includes('mechanical')) {
        return [keyboardMechanical, keyboardRgb, keyboardMechanical];
      }
      return [keyboardRgb, keyboardMechanical, keyboardRgb];
    }
    if (productName.toLowerCase().includes('mouse')) {
      if (productName.toLowerCase().includes('wireless') || productName.toLowerCase().includes('sem fio')) {
        return [mouseWireless, mouseGaming, mouseWireless];
      }
      return [mouseGaming, mouseWireless, mouseGaming];
    }
    
    // Rotation for other office items
    ...
    if (variation === 2) return [monitorCurved, mouseWireless, officeChair];
    return [monitorProfessional, mouseWireless, keyboardRgb];
  }
  
  // Acessórios - Now with 2 powerbank images
  if (categoria === 'acessorios') {
    if (productName.toLowerCase().includes('powerbank') || productName.toLowerCase().includes('bateria')) {
      if (variation % 2 === 0) return [powerbankBlack, accessoryPowerbank, powerbankBlack];
      return [accessoryPowerbank, powerbankBlack, accessoryPowerbank];
    }
    ...
    // Rotation for other accessories
    if (variation === 0) return [accessoryCable, powerbankBlack, accessoryPhoneCase];
    if (variation === 1) return [accessoryPhoneCase, accessoryCable, accessoryPowerbank];
    if (variation === 2) return [powerbankBlack, accessoryPhoneCase, accessoryCable];
    return [accessoryPowerbank, accessoryPhoneCase, powerbankBlack];
  }
  
  // Default with more variation
  if (variation === 0) return [laptopBusiness, laptopGaming, phoneSamsung];
  if (variation === 1) return [laptopGaming, phoneAndroidBlue, laptopUltrabook];
  if (variation === 2) return [laptopMacbook, laptopBusiness, phoneMidrangeGreen];
  return [phoneIphone, laptopGaming, laptopBusiness];
};
