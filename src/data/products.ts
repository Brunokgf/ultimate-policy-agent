...
export const allProducts: Product[] = [
  ...
  { id: 'tel-5', nome: 'Samsung Galaxy A54 5G', descricao: '256GB, Verde', preco: 2299.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Mais vendido da linha Galaxy A, câmera tripla de 50MP', especificacoes: ['256GB', '5G', 'Exynos 1380', 'Bateria 5000mAh'] },
  { id: 'tel-6', nome: 'Motorola Moto G84', descricao: '256GB, Preto', preco: 1499.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Best-seller Motorola com tela OLED de 120Hz', especificacoes: ['256GB', 'OLED 120Hz', 'Snapdragon 695', '5000mAh'] },
  { id: 'tel-7', nome: 'Xiaomi Redmi Note 12', descricao: '128GB, Azul', preco: 1199.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Campeão de vendas no Brasil, ótimo custo-benefício', especificacoes: ['128GB', 'Snapdragon 685', '50MP', '5000mAh'] },
  { id: 'tel-8', nome: 'Samsung Galaxy A14', descricao: '128GB, Preto', preco: 899.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Celular mais vendido no Brasil em 2024', especificacoes: ['128GB', 'MediaTek Helio G80', '50MP', '5000mAh'] },
  { id: 'tel-9', nome: 'iPhone 13', descricao: '128GB, Azul', preco: 4299.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'iPhone best-seller com ótimo preço', especificacoes: ['128GB', 'A15 Bionic', '12MP', '5G'] },
  { id: 'tel-10', nome: 'Motorola Edge 40 Neo', descricao: '256GB, Preto', preco: 1799.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Tela OLED curva de 144Hz, carregamento 68W', especificacoes: ['256GB', 'MediaTek 7030', '144Hz', '68W'] },
  ...
  { id: 'tel-20', nome: 'Motorola Moto G24', descricao: '128GB, Grafite', preco: 699.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Melhor custo-benefício Motorola', especificacoes: ['128GB', 'Helio G85', '50MP', '5000mAh'] },
  { id: 'tel-21', nome: 'Nothing Phone 2', descricao: '256GB, Branco', preco: 3499.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Design único com Glyph Interface', especificacoes: ['256GB', 'Snapdragon 8+ Gen 1', '50MP', 'LED traseiro'] },
  { id: 'tel-22', nome: 'ASUS Zenfone 10', descricao: '256GB, Preto', preco: 3799.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Compacto e potente com Snapdragon 8 Gen 2', especificacoes: ['256GB', 'Snapdragon 8 Gen 2', '50MP', 'Compacto'] },
  { id: 'tel-23', nome: 'Google Pixel 7a', descricao: '128GB, Azul', preco: 2799.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Melhor câmera intermediária com IA Google', especificacoes: ['128GB', 'Tensor G2', '64MP', 'IA avançada'] },
  { id: 'tel-24', nome: 'Xiaomi 13T', descricao: '256GB, Preto', preco: 2899.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Câmera Leica e carregamento 67W', especificacoes: ['256GB', 'Dimensity 8200', 'Leica', '67W'] },
  { id: 'tel-25', nome: 'Samsung Galaxy Z Flip 5', descricao: '256GB, Lavanda', preco: 5999.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Dobrável compacto mais vendido', especificacoes: ['256GB', 'Snapdragon 8 Gen 2', 'Dobrável', 'Tela externa'] },
  { id: 'tel-26', nome: 'Motorola Razr 40', descricao: '256GB, Preto', preco: 3999.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Dobrável com melhor preço', especificacoes: ['256GB', 'Snapdragon 7 Gen 1', 'Dobrável', 'OLED'] },
  { id: 'tel-27', nome: 'OnePlus 11', descricao: '256GB, Verde', preco: 3799.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Carregamento de 100W e câmera Hasselblad', especificacoes: ['256GB', 'Snapdragon 8 Gen 2', '100W', 'Hasselblad'] },
  { id: 'tel-28', nome: 'Realme GT Neo 5', descricao: '256GB, Branco', preco: 2699.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Carregamento mais rápido do mundo - 240W', especificacoes: ['256GB', 'Snapdragon 8+ Gen 1', '240W', '144Hz'] },
  { id: 'tel-29', nome: 'Poco F5 Pro', descricao: '256GB, Branco', preco: 2499.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Flagship killer com Snapdragon 8+ Gen 1', especificacoes: ['256GB', 'Snapdragon 8+ Gen 1', '64MP', '67W'] },
  { id: 'tel-30', nome: 'Samsung Galaxy A24', descricao: '128GB, Preto', preco: 1299.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Display Super AMOLED e bateria 5000mAh', especificacoes: ['128GB', 'Helio G99', '50MP', 'Super AMOLED'] },
  { id: 'tel-31', nome: 'Motorola Edge 30 Fusion', descricao: '128GB, Azul', preco: 1999.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Design premium com Snapdragon 888+', especificacoes: ['128GB', 'Snapdragon 888+', '50MP', 'OLED 144Hz'] },
  { id: 'tel-32', nome: 'Xiaomi 12 Lite', descricao: '256GB, Rosa', preco: 2199.00, categoria: 'telefones', imagens: ['📱', '📱', '📱'], detalhes: 'Design fino e leve com AMOLED 120Hz', especificacoes: ['256GB', 'Snapdragon 778G', '108MP', '67W'] },
  ...
  { id: 'fone-1', nome: 'AirPods Pro 2ª Geração', descricao: 'Cancelamento de ruído ativo', preco: 2199.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Fone mais vendido da Apple com ANC adaptável', especificacoes: ['ANC', 'Áudio Espacial', 'Até 6h', 'IPX4'] },
  { id: 'fone-2', nome: 'Sony WH-1000XM5', descricao: 'Premium noise cancelling', preco: 2299.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Melhor ANC do mercado segundo testes', especificacoes: ['ANC Premium', '30h bateria', 'LDAC', '8 microfones'] },
  { id: 'fone-3', nome: 'JBL Tune 510BT', descricao: 'On-ear sem fio', preco: 199.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Fone JBL mais vendido no Brasil', especificacoes: ['40h bateria', 'Pure Bass', 'Dobrável', 'USB-C'] },
  { id: 'fone-4', nome: 'Samsung Galaxy Buds2 Pro', descricao: 'In-ear com ANC', preco: 1099.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Best-seller Samsung com Hi-Fi 24bit', especificacoes: ['ANC', '8h', 'IPX7', '360 Audio'] },
  { id: 'fone-5', nome: 'Edifier W800BT Plus', descricao: 'Over-ear Bluetooth', preco: 249.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Campeão de vendas no Brasil', especificacoes: ['80h bateria', 'Dobrável', 'Almofadas macias', 'Bluetooth 5.3'] },
  { id: 'fone-6', nome: 'Beats Studio Buds+', descricao: 'True Wireless', preco: 1099.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'ANC e design compacto Beats', especificacoes: ['ANC', '9h', 'IPX4', 'USB-C'] },
{ id: 'fone-7', nome: 'Anker Soundcore Life Q30', descricao: 'ANC híbrido', preco: 499.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Best-seller Amazon com ANC eficiente', especificacoes: ['ANC Híbrido', '40h', 'Hi-Res', 'USB-C'] },
  { id: 'fone-8', nome: 'Xiaomi Redmi Buds 4 Pro', descricao: 'TWS com ANC', preco: 399.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'TWS mais vendido da Xiaomi', especificacoes: ['ANC 43dB', '9h', 'IP54', 'Spatial Audio'] },
  { id: 'fone-9', nome: 'JBL Live Pro 2', descricao: 'TWS premium', preco: 799.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'True Adaptive ANC e áudio espacial', especificacoes: ['Smart ANC', '10h', 'IPX5', 'JBL Signature'] },
  { id: 'fone-10', nome: 'Sony WF-1000XM5', descricao: 'TWS top de linha', preco: 1999.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Melhor TWS do mercado em 2024', especificacoes: ['ANC class-leading', '8h+16h', 'LDAC', 'IPX4'] },
  { id: 'fone-11', nome: 'Bose QuietComfort Earbuds II', descricao: 'TWS ANC personalizado', preco: 1799.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'ANC que se adapta ao seu ouvido', especificacoes: ['CustomTune', '6h', 'IPX4', 'Fit personalizado'] },
  { id: 'fone-12', nome: 'Motorola Moto Buds+', descricao: 'TWS com ANC', preco: 499.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'TWS Motorola com melhor custo-benefício', especificacoes: ['ANC', '8h+24h', 'IPX5', 'Dolby Audio'] },
  { id: 'fone-13', nome: 'Philips TAH4205', descricao: 'Over-ear Bluetooth', preco: 179.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Fone Philips mais vendido', especificacoes: ['29h', 'Bass Boost', 'Dobrável', 'Almofadas soft'] },
  { id: 'fone-14', nome: 'Sennheiser Momentum 4', descricao: 'Over-ear audiófilo', preco: 2499.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Qualidade de som referência', especificacoes: ['ANC adaptável', '60h', 'aptX Adaptive', 'Hi-Res'] },
  { id: 'fone-15', nome: 'QCY T13', descricao: 'TWS econômico', preco: 79.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'TWS mais vendido na Shopee', especificacoes: ['8h+32h', 'Bluetooth 5.3', 'IPX4', 'Touch control'] },
  { id: 'fone-16', nome: 'Baseus Bowie M2', descricao: 'TWS ANC acessível', preco: 199.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'ANC com preço imbatível', especificacoes: ['ANC -43dB', '7h+30h', 'LDAC', 'IPX6'] },
  { id: 'fone-17', nome: 'Havit H2232d', descricao: 'Headset Gamer USB', preco: 89.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Headset gamer mais vendido', especificacoes: ['7.1 Surround', 'RGB', 'Microfone', 'Almofadas gel'] },
  { id: 'fone-18', nome: 'Logitech G733', descricao: 'Headset Wireless RGB', preco: 799.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Headset gamer sem fio mais vendido', especificacoes: ['Lightspeed', '29h', 'Blue VO!CE', 'RGB Lightsync'] },
  { id: 'fone-19', nome: 'HyperX Cloud II', descricao: 'Headset Gamer 7.1', preco: 499.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Headset profissional e-sports', especificacoes: ['7.1 Virtual', 'Mic destacável', 'Almofadas memory', 'USB'] },
  { id: 'fone-20', nome: 'Razer BlackShark V2', descricao: 'Headset E-sports', preco: 599.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Usado por pro players', especificacoes: ['THX Spatial', 'Drivers 50mm', 'Mic HyperClear', 'Leve 262g'] },
  { id: 'fone-21', nome: 'Apple AirPods 3ª Geração', descricao: 'Design aberto', preco: 1599.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'AirPods com áudio espacial', especificacoes: ['Spatial Audio', '6h+30h', 'IPX4', 'MagSafe'] },
  { id: 'fone-22', nome: 'Soundcore Liberty 4', descricao: 'TWS Hi-Res', preco: 699.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'TWS com certificação Hi-Res', especificacoes: ['LDAC', 'ANC', '9h+28h', 'IPX4'] },
  { id: 'fone-23', nome: 'Jabra Elite 85t', descricao: 'TWS profissional', preco: 1199.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'TWS para calls e música', especificacoes: ['ANC ajustável', '6 mics', '5.5h+25h', 'IPX4'] },
  { id: 'fone-24', nome: 'Lenovo LP40 Pro', descricao: 'TWS econômico', preco: 49.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'TWS mais vendido no AliExpress', especificacoes: ['Bluetooth 5.1', '4h+20h', 'Touch', 'IPX5'] },
  { id: 'fone-25', nome: 'Shokz OpenRun Pro', descricao: 'Condução óssea', preco: 1299.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Fone esportivo por condução óssea', especificacoes: ['10h bateria', 'IP67', 'Quick charge', 'Seguro'] },
  { id: 'fone-26', nome: 'JBL Wave Beam', descricao: 'TWS compacto', preco: 299.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'TWS JBL acessível', especificacoes: ['8h+24h', 'IP54', 'Deep Bass', 'USB-C'] },
  { id: 'fone-27', nome: 'Edifier TWS1 Pro', descricao: 'TWS gaming', preco: 349.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'TWS com baixa latência para jogos', especificacoes: ['Low Latency 80ms', '12h+42h', 'IP55', 'Gaming mode'] },
  { id: 'fone-28', nome: 'Audio-Technica ATH-M50x', descricao: 'Monitor profissional', preco: 1299.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Referência para produção musical', especificacoes: ['Drivers 45mm', 'Dobrável', 'Cabo destacável', 'Studio grade'] },
  { id: 'fone-29', nome: 'Philips SHP9500', descricao: 'Open-back Hi-Fi', preco: 699.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Fone aberto audiófilo', especificacoes: ['Open-back', 'Drivers 50mm', 'Conforto', 'Som natural'] },
  { id: 'fone-30', nome: 'Corsair HS55 Stereo', descricao: 'Headset multiplataforma', preco: 299.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Headset compatível com tudo', especificacoes: ['Multi-platform', 'Mic unidirecional', 'Leve', 'P2'] },
  { id: 'fone-31', nome: 'Bose SoundLink II', descricao: 'Over-ear Bluetooth', preco: 1499.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Som Bose característico', especificacoes: ['15h', 'NFC', 'Multi-device', 'Dobrável'] },
  { id: 'fone-32', nome: 'Steelseries Arctis Nova Pro', descricao: 'Headset gamer premium', preco: 2199.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Headset profissional com DAC', especificacoes: ['DAC Hi-Res', 'ANC', 'Hot-swap', '360 Spatial'] },
  { id: 'fone-33', nome: 'KZ ZSN Pro X', descricao: 'In-ear audiófilo', preco: 129.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'IEM com melhor custo-benefício', especificacoes: ['Hybrid BA+DD', 'Cabo destacável', 'Metal', 'Hi-Res'] },
  { id: 'fone-34', nome: 'Sony WH-CH520', descricao: 'On-ear econômico', preco: 299.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Sony acessível com bateria gigante', especificacoes: ['50h bateria', 'Quick charge', 'Leve', 'Multi-point'] },
  { id: 'fone-35', nome: 'Huawei FreeBuds 5i', descricao: 'TWS ANC', preco: 449.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'TWS Huawei com ANC eficiente', especificacoes: ['ANC 42dB', '7.5h+28h', 'LDAC', 'IP54'] },
  { id: 'fone-36', nome: 'Gamesir T1s', descricao: 'Headset gamer RGB', preco: 179.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Headset gamer com ótimo preço', especificacoes: ['7.1', 'RGB', 'Drivers 50mm', 'P2+USB'] },
  { id: 'fone-37', nome: 'Oneodio A71', descricao: 'Monitor Studio', preco: 199.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Fone para produção musical', especificacoes: ['Drivers 40mm', 'Dobrável', 'Shareport', '2 cabos'] },
  { id: 'fone-38', nome: 'QCY HT05', descricao: 'TWS ANC econômico', preco: 149.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'ANC acessível da QCY', especificacoes: ['ANC 40dB', '7h+30h', 'App', 'IPX5'] },
  { id: 'fone-39', nome: 'Haylou GT7', descricao: 'TWS gaming', preco: 139.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'TWS para gamers mobile', especificacoes: ['Latência 65ms', '5h+20h', 'Game mode', 'IPX4'] },
  { id: 'fone-40', nome: 'Redragon Zeus X', descricao: 'Headset 7.1 RGB', preco: 249.00, categoria: 'fones', imagens: ['🎧', '🎧', '🎧'], detalhes: 'Headset gamer best-seller', especificacoes: ['7.1 Surround', 'RGB', 'Drivers 53mm', 'USB'] },

  // Computadores - 40 produtos
  { id: 'comp-1', nome: 'MacBook Pro 14" M3', descricao: '16GB RAM, 512GB SSD', preco: 14999.00, categoria: 'computadores', imagens: ['💻', '💻', '💻'], detalhes: 'MacBook mais vendido no mundo', especificacoes: ['M3', '16GB', '512GB SSD', 'Tela 14.2" XDR'] },
